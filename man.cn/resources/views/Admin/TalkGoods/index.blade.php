                                    ...
                                    <table aria-describedby="dataTables-example_info" role="grid"
                                        ...
                                        @foreach($res as $v)
                                            <tr role="row" class="gradeA odd" align="center">
                                                ...
                                                <td><a class="updatestatus" sid="{{$v->id}}"><span class = "statu"><button class="btn btn-info" type="button">{{$v->status==1?'屏蔽':'显示'}}</button></span> </a></td>
    ...
    <script>
        ...
        $('.updatestatus').click(function () {
            ...
            $.post('/Admin/TalkGoods/updatesta',{id:id},function(data){
                ...
                if(data=="显示")
                {   
                    $('.statu').html('<button class="btn btn-danger" type="button">屏蔽</button>').css('color','red');
                }else{
                    $('.statu').html('<button class="btn btn-info" type="button">显示</button>').css('color','green');
                }
            })
        })
