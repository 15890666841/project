...
<div class="panel-body">
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3">
            <form role="form" method="post" action="/Admin/Config/update">
                ...
                <div class="form-group">
                    ...
                    <div class="radio">
                        <label>
                            <input name="sex" id="optionsRadios1" value="0" {{ $resd->sex==0 ?'checked':''}} type="radio">女
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input name="sex" id="optionsRadios2" value="1" {{ $resd->sex==1 ?'checked':''}} type="radio">男
                        </label>
                    </div>
